...
def game(distance):
    ...
    while closeapp != True:
        ...
        runway2 = rect.Rect(distance, 700, 100000, 50)
        runways = [runway, runway2]
        buildings = []
        colours = []
        for i in range(1000):
            height = randint(50, 200)
            buildings.append(rect.Rect((randint(120000, (distance - 20000))), (750 - height), randint(50, 100), height))
...
while closeall == False:
    ...
    text1 = font1.render('Athens -> Thessaloniki', True, (0, 0, 0))
    text2 = font1.render('Athens -> Rome', True, (0, 0, 0))
    menutext = font1.render('Choose a map', True, (0, 0, 0))
    texts = [text1, text2]
    distances = [500000, 1500000]
    clock = time.Clock()
    xclick = None
    yclick = None
    while True:
